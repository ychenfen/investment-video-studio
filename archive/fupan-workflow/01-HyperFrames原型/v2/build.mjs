  ...
  <body>
    <div id="root" data-composition-id="main" data-start="0" data-duration="${D}" data-width="1080" data-height="1920">
      ...
      <section id="sc-dialog" class="clip scene" ${sceneAttrs("dialog")}><div class="sin" id="dg-in"><div class="cam" id="dg-cam"><div class="pun" id="dg-pun">
        ...
        <div class="chat">
          <div class="msg" id="dg-m1" style="top:0"><div class="dav">${avatar("dg-ab", "aben")}</div><div><div class="who">阿本</div><div class="typing" id="dg-t1"><i></i><i></i><i></i></div><div class="bub bub-b" id="dg-b1">你昨天到底看了什么？</div></div></div>
          <div class="msg r" id="dg-m2" style="top:340px"><div class="dav">${avatar("dg-yu", "xiaoyu")}</div><div><div class="who">小于</div><div class="typing" id="dg-t2" style="margin-left:auto"><i></i><i></i><i></i></div><div class="bub bub-y" id="dg-b2">看哪些股票涨得好啊</div>
    ...
    <script>
      ...
      tl.fromTo("#st-yu", { y: 260, opacity: 0 }, { y: 0, opacity: 1, duration: 0.45, ease: "back.out(1.6)" }, PH("struggle", 3).start + 0.1);
